  	...
  	<div class="container">
  		<nav class="navbar navbar-expand-lg navbar-light bg-light rounded mt-0">
       		<div class="collapse navbar-collapse mt-0">
       			<ul class="navbar-nav mr-auto">
           			<li class="nav-item active">成功借阅的书籍条目 <span class="sr-only">(current)</span></li>
       			</ul>
       		</div>
      	</nav>
      	<div class="table-responsive">
		 	<table class="table">
				...
				<tbody>
					<c:forEach items="${successBorrow}" var="inform" varStatus="status">
						<tr>
      	...
      	<nav class="navbar navbar-expand-lg navbar-light bg-light rounded mt-0">
       		<div class="collapse navbar-collapse mt-0">
       			<ul class="navbar-nav mr-auto">
           			<li class="nav-item active">借阅失败的书籍条目 <span class="sr-only">(current)</span></li>
       			</ul>
       		</div>
      	</nav>
      	<div class="table-responsive">
		 	<table class="table">
				...
				<tbody>
					<c:forEach items="${loseBorrow}" var="inform" varStatus="status">
						<tr>
							<td>${inform.bookcode}</td>
							<td>${inform.bookname}</td>
							<td>${inform.bookauthor}</td>
		 ...
		 <div class="row">
		 	...
		 	<div class="col-2">
		 		<form action="${returnURL}" method=post>
		 			<button type="submit" class="btn btn-Success btn-lg">返回上一界面</button>
		 		</form>
		 	</div>
		 	<div class="col-5"></div>
		 </div>
