  		...
  		<div class="col-md-9" >
  			<div class="col-md-2"></div>
  				<div class="col-md-8" style="background-color:white">
  					<form action="InformChange/input" method=post>
								...
								<tbody>
									<tr>
										...
										<td>
											...
											<input type="hidden" name="nowchangename" value="${holdingUsers.usersname}">
									...
									<tr>
										...
										<td>
											<input type="text" name="changephone" class="form-control">
											<input type="hidden" name="nowchangephone" value="${holdingUsers.usersphone}">
										</td>
									</tr>
								</tbody>	
							</table>
